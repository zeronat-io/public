# =============================================================================
# Example: Single ZeroNAT HA Cluster
# =============================================================================
#
# Topology:
#
...
resource "aws_vpc" "this" {
  ...
  tags = { Name = "zeronat-cluster-basic" }
}
...
# --- Public subnets (ZeroNAT nodes live here, one per AZ) ---
...
resource "aws_subnet" "public_a" {
  ...
  tags = { Name = "zeronat-cluster-basic-public-a" }
}
...
resource "aws_subnet" "public_b" {
  ...
  tags = { Name = "zeronat-cluster-basic-public-b" }
}
...
resource "aws_subnet" "private_a" {
  ...
  tags = { Name = "zeronat-cluster-basic-private-a" }
}
...
resource "aws_subnet" "private_b" {
  ...
  tags = { Name = "zeronat-cluster-basic-private-b" }
}
...
resource "aws_route_table" "public" {
  ...
  tags = { Name = "zeronat-cluster-basic-public" }
}
...
# --- Private route tables: both managed by the cluster ---
...
# =============================================================================
# ZeroNAT Module — Cluster Mode (HA pair across AZs)
# =============================================================================
...
module "nat" {
  ...
  # Cluster controls both private route tables — on failover, all routes
  # are re-pointed to the surviving node's ENI.
  route_table_ids = [
...
resource "aws_instance" "test_a" {
  ...
  tags = { Name = "zeronat-cluster-basic-test-a" }
}
...
resource "aws_instance" "test_b" {
  ...
  tags = { Name = "zeronat-cluster-basic-test-b" }
}

# --- Test instance security group ---

resource "aws_security_group" "test" {
  name        = "zeronat-cluster-basic-test"
  description = "Test instances - egress all, SSH from VPC"
  vpc_id      = aws_vpc.this.id

  tags = { Name = "zeronat-cluster-basic-test" }
}
...
output "nat_instance_b_id" {
  value = module.nat.instance_b_id
}
